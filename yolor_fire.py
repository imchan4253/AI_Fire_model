...
if __name__ == "__main__":
    ...
    #model_name1 = "person_car_tiny.onnx"

    #path = "stream_test2.mp4"

    #model_name = "cks.onnx"
    model_name = "best_fire.onnx"
    #model_name = ".onnx"

    #path ="b_10m_on.avi"
    aaa = glob.glob('/workspace/sam_person/_aibox/liv_test/news.*')
    for filePath in aaa:
        with open(filePath, 'rb') as f:
             ...
             record = "/workspace/sam_person/_aibox/liv_fire/"+str(path.split('.')[0])+"_firefire_out.mp4"
                ...
                #return path, img, img0, self.cap 
                 ...
                 if 0 in filtered_boxes:
                    ...
                    for fire_box in filtered_boxes[0][:, 0:]:
                        ...
                        cv2.putText(original, "fire : "+str(rate), (X0+5,Y0+40), cv2.FONT_HERSHEY_SIMPLEX, 1, [0, 255, 0],2)
